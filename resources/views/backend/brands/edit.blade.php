            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-10">
                       ...
                       <input type="file" name="logo" id="logo" class="form-control" placeholder="Upload Brand Image">
                        ...
                        <!-- {{ Form::text('value', $brand->logo, ['class' => 'form-control']) }} -->
                    </div><!--col-lg-3-->
                </div><!--form control-->
            </div><!-- /.box-body -->
        </div><!--box--> 
